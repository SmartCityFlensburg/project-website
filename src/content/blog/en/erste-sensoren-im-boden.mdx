...
The sensors record soil moisture and soil temperature at two depths (40 and 80 cm). The reading at 80 cm shows whether the water reaches the layers the roots draw from, or whether only the surface got wet. On this basis, the platform will eventually show when irrigation is necessary, so that watering runs go exactly where they are needed.
